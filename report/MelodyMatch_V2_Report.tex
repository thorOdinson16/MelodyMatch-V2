% MelodyMatch-V2 Research Report
% Compile with: pdflatex report.tex (run twice for references/table of contents as needed)
...
The audio files themselves were not modified or deleted as part of the duration-outlier decision. The exclusions were recorded in the cleaned manifests.
